...
const Pagination = ({pages, setCurrentPage, currentEmployee, empNumber}) => {
    ...
    return (
        <div className="clearfix">
            <div className="hint-text">Showing <b>{currentEmployee.length}</b> out of <b>{empNumber}</b> entries</div>
